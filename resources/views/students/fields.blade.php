...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('Middlename', null, ['class' => 'form-control','maxlength' => 100,'maxlength' => 100]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('Citizenship', null, ['class' => 'form-control','maxlength' => 100,'maxlength' => 100]) !!}
</div>

<!-- Religion Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Religion', 'Religion:') !!}
    {!! Form::text('Religion', null, ['class' => 'form-control','maxlength' => 100,'maxlength' => 100]) !!}
</div>